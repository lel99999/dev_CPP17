...
int main(){
  int a[10] = {100,10,30,20,60,80,5,50,30,25};
  ...
  double b[5] = {85.6d,76.13d,0.012d,1.57d,2.56.d};
  ...
  string names[7] =  {"blake","carol","josh","eileen","kerry","joanne","billy"}

  cout << "\nNames before sorting ..." << endl;
  copy(names,name+6,ostream_iterator<string>(cout,"\n"));
  cout << endl;
